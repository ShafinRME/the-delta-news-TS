...
const Crime = () => {
  const [crimeNews, setCrimeNews] = useState<NewsProps[]>([]);
  useEffect(() => {
    // fetch(`${url}/america`)
        ...
        <>
          ...
          <div className="">
            ...
            <h2 className="text-3xl hover:text-error-content transition-colors duration-500 mb-3">
              <Link to="/bangladesh/crime">Crime</Link>
            </h2>
          ...
          <section className="mt-5">
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
              <div className="xl:col-span-8  border">
                {/* first part */}
                {crimeNews.slice(13, 14).map((news) => (
                  <>
                    <Link to={`/bangladesh/crime/${news.slug}`}>
                      <div className="p-2" key={news.slug}>
                        <img className="w-full" src={news.image} alt="" />
              ...
              <div className="xl:col-span-4">
                ...
                {crimeNews.slice(13, 16).map((news) => (
                  <>
                    <Link to={`/bangladesh/crime/${news.slug}`}>
                      <div
                        className="border m-2 grid grid-cols-2"
