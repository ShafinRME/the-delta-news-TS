...
const LocalSports = () => {
  const [localSportsNews, setLocalSportsNews] = useState<NewsProps[]>([]);
  useEffect(() => {
    // fetch(`${url}/america`)
      ...
      {localSportsNews.length <= 0 ? (
        ...
        <>
          ...
          <section>
            <div className="">
              ...
              <h2 className="text-3xl hover:text-error-content transition-colors duration-500 mb-3">
                <Link to="/sports/localsports">Local Sports</Link>
              </h2>
          ...
          <section>
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
              ...
              <div className="xl:col-span-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                  <div className="grid grid-cols-2">
                    {localSportsNews.slice(0, 4).map((news) => (
                      <>
                  ...
                  <div className="border">
                    {localSportsNews.slice(8, 9).map((news) => (
                      <Link to={`/sports/localsports/${news.slug}`}>
              ...
              <div className="xl:col-span-4">
                {localSportsNews.slice(5, 8).map((news) => (
                  <>
                    <Link to={`/sports/localsports/${news.slug}`}>
                      <div
          ...
          <section className="m-5">
            {localSportsNews.slice(9, 13).map((news) => (
              <>
                <Link to={`/sports/localsports/${news.slug}`}>
                  <div
          ...
          <section className="mt-5">
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-5">
              <div className="xl:col-span-8  border">
                {/* first part */}
                {localSportsNews.slice(13, 14).map((news) => (
                  <>
                    <Link to={`/sports/localsports/${news.slug}`}>
                      <div className="p-2" key={news.slug}>
                        <img className="w-full" src={news.image} alt="" />
              ...
              <div className="xl:col-span-4">
                ...
                {localSportsNews.slice(13, 16).map((news) => (
                  <>
                    <Link to={`/sports/localsports/${news.slug}`}>
                      <div
                        className="border m-2 grid grid-cols-2"
